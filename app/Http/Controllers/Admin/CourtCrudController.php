...
use App\Http\Requests\CourtRequest as StoreRequest;
use App\Http\Requests\CourtRequest as UpdateRequest;
...
class CourtCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Court');
        $this->crud->setRoute(config('backpack.base.route_prefix', 'admin') . '/courts');
