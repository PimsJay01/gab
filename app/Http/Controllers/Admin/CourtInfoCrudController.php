...
use App\Http\Requests\CourtInfoRequest as StoreRequest;
use App\Http\Requests\CourtInfoRequest as UpdateRequest;

class CourtInfoCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\CourtInfo');
        $this->crud->setRoute(config('backpack.base.route_prefix', 'admin') . '/court_infos');
        $this->crud->setEntityNameStrings('courtinfo', 'court_infos');
